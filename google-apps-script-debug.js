/**
 * Business Evolution AI - Form Submission Handler (DEBUG VERSION)
 * 
 * This debug version provides detailed error logging
 */
...
function doPost(e) {
  try {
    ...
    try {
      ...
      console.log('ERROR: Failed to get active sheet:', sheetError);
      return ContentService
        .createTextOutput(JSON.stringify({
          success: false,
          message: 'Spreadsheet connection error: ' + sheetError.toString()
        }))
        .setMimeType(ContentService.MimeType.JSON);
    }
